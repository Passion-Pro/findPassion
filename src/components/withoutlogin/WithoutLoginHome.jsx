  ...
  return (
    <div className="without__home">
      ...
      <div className="without__homeBody">
        ...
        {current == "web" && webD.map((data) => <Box data={data} />)}
        ...
        {current == "app" && appD.map((data) => <Box data={data} />)}
        ...
        {current == "game" && gameD.map((data) => <Box data={data} />)}
        ...
        {current == "cp" && cp.map((data) => <Box data={data} />)}
        <div
          className="without__Head__Riv"
        ...
        {current == "design" && design.map((data) => <Box data={data} />)}
        ...
        {current == "video" && videoE.map((data) => <Box data={data} />)}
      </div>
    </div>
  );
}
